...
class _MidiPageState extends State<MidiPage> {
  ...
  final List<String> _productImages = [
    ...
    'assests/images/midi2.jpg',
    'assests/images/midi3.jpg',
    'assests/images/midi4.jpg',
  ];
  ...
  Future<void> fetchStock(String color) async {
    final response = await http.get(
      Uri.parse(
        'https://active-leopard-merely.ngrok-free.app/stock?type=Lilly Midi Dress Cotton Embroidery&color=$color',
      ),
    );
