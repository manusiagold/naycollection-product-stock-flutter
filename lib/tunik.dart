...
class TunikPage extends StatefulWidget {
  @override
  _TunikPageState createState() => _TunikPageState();
}

class _TunikPageState extends State<TunikPage> {
  ...
  final List<String> _productImages = [
    'assests/images/tunik1.jpg',
    'assests/images/tunik2.jpg',
    'assests/images/tunik3.jpg',
    'assests/images/tunik4.jpg',
    'assests/images/tunik5.jpg',
  ];

  final List<String> colors = ['Yellow', 'Purple', 'Denim', 'Olive', 'Lemon'];

  // Fungsi untuk mengambil data stok dari backend
  Future<void> fetchStock(String color) async {
    final response = await http.get(
      Uri.parse(
        'https://active-leopard-merely.ngrok-free.app/stock?type=Nay Tunik Polos Polo Linen&color=$color',
      ),
    );
