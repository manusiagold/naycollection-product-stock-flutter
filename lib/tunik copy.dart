...
class TunikPage extends StatefulWidget {
  @override
  _MidiPageState createState() => _MidiPageState();
}

class _MidiPageState extends State<TunikPage> {
  // This will hold the current image for the main product
  int _currentImageIndex = 0;

  // List of images for variations
  final List<String> _productImages = [
    'assests/images/tunik1.jpg', // Main Product Image 1
    'assests/images/tunik2.jpg', // Main Product Image 1
    'assests/images/tunik3.jpg', // Main Product Image 1
    'assests/images/tunik4.jpg', // Main Product Image 1
    'assests/images/tunik5.jpg', // Main Product Image 1
  ];
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              height: 400,
              child: Image.asset(
                _productImages[_currentImageIndex], // Display the current selected image
                fit: BoxFit.cover,
              ),
            ),
            // Product Variations
            Padding(
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Row(
                      children: [
                        GestureDetector(
                          ...
                          child: Image.asset(
                            'assests/images/tunik1.jpg', // Variation 1
                            width: 50,
                            height: 50,
                          ),
                        ),
                        ...
                        GestureDetector(
                          ...
                          child: Image.asset(
                            'assests/images/tunik2.jpg', // Variation 2
                            width: 50,
                            height: 50,
                          ),
                        ),
                        ...
                        GestureDetector(
                          ...
                          child: Image.asset(
                            'assests/images/tunik3.jpg', // Variation 2
                            width: 50,
                            height: 50,
                          ),
                        ),
                        ...
                        GestureDetector(
                          onTap: () {
                            setState(() {
                              _currentImageIndex =
                                  4; // Change to the third variation image
                            });
                          },
                          child: Image.asset(
                            'assests/images/tunik5.jpg', // Variation 3
                            width: 50,
                            height: 50,
                          ),
                        ),
                  ...
                  SizedBox(height: 10),
                  Text(
                    'Trendy tunik for casual outings.',
